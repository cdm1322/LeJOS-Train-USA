...
public class MasterBrick3 implements TimerListener {

	static double seconds = 0;

	static double record;
		
	static Timer timer = new Timer(10, new MasterBrick3());
			...
			*/			
			...
			while (ID != destination) {
				...
				if (three.getDistance() < 11 && ID != 3) {
					...
					try {// Using available() is terrible, threads are much more accurate
